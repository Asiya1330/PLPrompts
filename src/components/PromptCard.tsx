...
export default function PromptCard({ name, price, tag, image, rating }: PromptCardProps) {
  ...
  return (
    <div
      ...
      className="flex flex-col w-[270px] h-[240px] bg-no-repeat bg-cover bg-center border-2 border-[#FFFFFF4D] rounded-lg  cursor-pointer transition hover:mt-5"
